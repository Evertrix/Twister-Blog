        ...
        <main class="max-w-6xl mx-auto mt-10 lg:mt-20 space-y-6">
            ...
            <section class="col-span-8 col-start-5 mt-10 space-y-6">
                ...
                @foreach($post->comments->take(1) as $comment)
                    {{--                                    @include('comment.comment', ['comment' => $comment, 'post_id' => $post->id])--}}
                    {{--                                    @include('comment.comment', ['comments' => $post->comments, 'post_id' => $post->id])--}}
                    ...
                    <div class="display-comment" @if($comment->parent_id != null) style="margin-left:40px;" @endif>
                        ...
                        <article
                            ...
                            @if($comment->user->profile_image == null)
                                {{asset('/storage/avatar/default_avatar.png')}}
                            @else
                                {{asset('/storage/profile_image/'.$comment->user->profile_image)}}
                            @endif
                ...
                @if($post->comments->count() > 2 && !empty($comment))
                    @if(!empty($comment))
                        <div x-data="{ show: false }">
                            <button @click="show = !show" :aria-expanded="show ? 'true' : 'false'"
                                    :class="{ 'active': show }">
