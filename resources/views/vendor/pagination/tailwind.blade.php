@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex content-center items-center justify-between self-center ml-20">
...
{{--             style="margin-left:16em;"--}}
        >
            <div class="flex content-center items-center justify-between self-center">
                <p class="[toggle === '1' ? 'text-white-700' : 'text-gray-700'] text-sm leading-5">
                    {!! __('Showing') !!}
            ...
            <div class="mx-auto lg:mx-0 font-bold rounded-full my-6 py-4 px-8"
