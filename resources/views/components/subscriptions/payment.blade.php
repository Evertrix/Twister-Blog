...
{{--@section('content')--}}
 <x-layout>
     <div class="container mx-auto text-gray-900 my-48">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="payment-form" action="{{ route('payments.store') }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary w-100 text-white" id="card-button" data-secret="{{ $intent->client_secret }}">Pay</button>
                        </form>
                    </div>
                </div>
            </div>
