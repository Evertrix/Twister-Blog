...
# Database: twister_blog
# Generation Time: 2022-05-12 13:48:21 +0000
# ************************************************************
...
CREATE TABLE `payments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `s_payment_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `plans` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `plans_identifier_unique` (`identifier`),
